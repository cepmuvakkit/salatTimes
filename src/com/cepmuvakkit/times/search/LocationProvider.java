...
public class LocationProvider extends ContentProvider {
    ...
    public static String AUTHORITY = "com.cepmuvakkit.times.search.LocationProvider";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/location");

    // MIME types used for searching words or looking up a single definition
    public static final String WORDS_MIME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE +
                                                  "/vnd.cepmuvakkit.times.search";
    public static final String DEFINITION_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE +
                                                       "/vnd.cepmuvakkit.times.search";

    private LocationDatabase mLocations;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "location", SEARCH_WORDS);
        matcher.addURI(AUTHORITY, "location/#", GET_WORD);
        // to get suggestions...
    ...
    public boolean onCreate() {
        mLocations = new LocationDatabase(getContext());
        return true;
    }
    ...
    private Cursor getLocation(Uri uri) {
      ...
      String[] columns = new String[] {
          LocationDatabase.KEY_SEARCH,
          LocationDatabase.KEY_ORDER,
          LocationDatabase.KEY_COUNTRY,
          LocationDatabase.KEY_CITY,
          LocationDatabase.KEY_TIMEZONE,
          LocationDatabase.KEY_LATITUDE,
          LocationDatabase.KEY_LONGITUDE,    
      };

      return mLocations.getLocation(rowId, columns);
    }
