 ...
 */
package com.cepmuvakkit.times.conversion.phaseEvents;
...
public class MoonPhases {
	 ...
	 * @param phase
	 *            the calculated Moon Phase Angle [in degrees] New Moon=0 New
	...
	public double searchPhaseEvent(double jd, double ΔT, int phase) {
		...
		moonPos = lunar.calculateMoonEclipticCoordinatesAstronomic(jd, ΔT);
