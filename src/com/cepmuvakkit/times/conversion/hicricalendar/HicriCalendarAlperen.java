 ...
 * Abdurrahman ÖZLEM tarafından yapılan alperen programında kullanılan Hijri takvim hesaplama
 * algorithması kullanılarak java kaynak koduna uyarlanmıştır.
 * http://vakitmatik.tripod.com/alperen/sources.zip
 */
public class HicriCalendarAlperen {
	...
	private final double jd2000 = 2451544.5; // julian day of 1 January 2000
	...
	public HicriCalendarAlperen(double jd) {
		...
		hijriDay = hday;
		hijriYear = (short) ((jd-hday-jd2000) /synmonth + ILNBase);
