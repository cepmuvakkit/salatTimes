...
public class AstroLib {
	...
	/**
	 * @param milliseconds
	 *            is the milliseconds with long integer
	 * @return int[] {year, month, day};
	 */
	public static int[] convertMillis2HHMMSS(long milliseconds) {
		int Hour =  (int) (milliseconds / 3600000L);
		int Minute =(int) (milliseconds / 60000L % 60L);
	 ...
	 * @return hour double
	 */
	public static double  getLocalHourFromGregor(Calendar c) {
	...
	public static  String getStringHHMMfromDayFrac(double dayfrac, double timezone) {
		return getStringHHMM(dayFracToLocalHour(dayfrac, timezone));
	}

	public static  String isPreceedingOrFollowingDay(byte isPreceedingOrFollowing) {
	...
	public static String getHHMMfromGreCal(GregorianCalendar gdate) {
