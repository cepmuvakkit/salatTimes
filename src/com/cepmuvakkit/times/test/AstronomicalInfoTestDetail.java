...
public class AstronomicalInfoTestDetail {
	...
	LunarPosition lunar;
	private static DecimalFormat sixDigitFormat;
	public static void main(String[] args) {
		sixDigitFormat = new DecimalFormat("#0.0000000");
		...
		jd = AstroLib.calculateJulianDay(2013, 5, 1, 0, 1, 0, 3);
		...
		System.out.println("SOLAR Radius Vector in AU :" + sixDigitFormat.format(sunEq.Δ));
